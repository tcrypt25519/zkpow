...
├── justfile
├── audits/
│   └── SP1 Helios - Zellic Audit Report.pdf
├── contracts/
│   ├── foundry.toml
│   ├── foundry.lock
│   ├── script/
...
# helios
helios = { git = "https://github.com/a16z/helios", tag = "0.10.2" }
helios-consensus-core = { git = "https://github.com/a16z/helios", tag = "0.10.2" }
helios-ethereum = { git = "https://github.com/a16z/helios", tag = "0.10.2" }
...
alloy = { version = "1.0.37", features = ["full", "signer-ledger"] }
anyhow = "1.0.86"
reqwest = "0.12.5"
tree_hash = "0.10.0"
...
version = "1.0.31"
source = "registry+https://github.com/rust-lang/crates.io-index"
checksum = "0dd889b1543d5f05ba9c4b2ed45345da191e1fb335840ef835aec61fd50fdc8f"
dependencies = [
 "alloy-consensus",
 "alloy-network",
 "alloy-primitives",
...
version = "1.0.41"
source = "registry+https://github.com/rust-lang/crates.io-index"
checksum = "4599a95670313c028b1f69c425deee72c26f2c4911713eb49a4d5faf9eb67c29"
dependencies = [
 "alloy-consensus",
 "alloy-network",
 "alloy-primitives",
...
version = "0.7.0"
source = "git+https://github.com/ncitron/ethereum_hashing?rev=7ee70944ed4fabe301551da8c447e4f4ae5e6c35#7ee70944ed4fabe301551da8c447e4f4ae5e6c35"
dependencies = [
 "cpufeatures",
 "sha2 0.10.9",
]
...
name = "helios-common"
version = "0.10.2"
source = "git+https://github.com/a16z/helios?tag=0.10.2#e1f9a50f73d7af6f6ae4acf2b663d04aab6adb19"
dependencies = [
 "alloy",
 "async-trait",
 "eyre",
...
/script/examples/*
```
## File: SP1 Helios - Zellic Audit Report.pdf
```pdf
Error reading SP1 Helios - Zellic Audit Report.pdf: 'utf-8' codec can't decode byte 0xe4 in position 10: invalid continuation byte
```
## File: .env.example
```
SP1_PROVER=
NETWORK_PRIVATE_KEY=
```
## File: return-image.png
```
Error reading return-image.png: 'utf-8' codec can't decode byte 0x89 in position 0: invalid start byte
```
## File: book.toml
```
[book]
...
[preprocessor.links]
```
## File: audits/SP1 Helios - Zellic Audit Report.pdf
```pdf
Error reading audits/SP1 Helios - Zellic Audit Report.pdf: 'utf-8' codec can't decode byte 0xe4 in position 10: invalid continuation byte
```
...
out = "out"
libs = ["lib"]
fs_permissions = [{ access = "read", path = "genesis.json" }]
...
ignore = ["lib/**"]
```
## File: contracts/foundry.lock
```
{
  "lib/sp1-contracts": {
    "rev": "af1ae093ef8a8f68b022aa8f0f7ad9ffd94aa6fb"
  }
}
```
...
```
## File: script/rust-toolchain
```
[toolchain]
channel = "1.86.0"
components = ["llvm-tools", "rustc-dev"]
```
## File: script/build.rs
```
...
```
## File: book/reproducible-builds.md
```markdown
# Reproducible Builds
...
```
## File: elf/light_client
```
Error reading elf/light_client: 'utf-8' codec can't decode byte 0xf3 in position 18: invalid continuation byte
```
## File: elf/storage
```
Error reading elf/storage: 'utf-8' codec can't decode byte 0xf3 in position 18: invalid continuation byte
```
## File: program/src/light_client.rs
```
#![no_main]
...
```
## File: .github/workflows/foundry.yaml
```yaml
name: CI
...
jobs:
  check:
    ...
    steps:
      ...
      #   id: test
```
## File: .github/workflows/pr_lint.yaml
```yaml
name: PR Lint
...
```
## File: contracts/src/SP1Helios.sol
```
// SPDX-License-Identifier: UNLICENSED
pragma solidity ^0.8.22;
